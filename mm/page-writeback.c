 ...
 */
#if defined(CONFIG_ADAPTIVE_DIRTY_BACKGROUND_RATIO) || defined(CONFIG_ZEN_INTERACTIVE)
 ...
 */
#if defined(CONFIG_ADAPTIVE_VM_DIRTY_RATIO) || defined(CONFIG_ZEN_INTERACTIVE)
#define DEFAULT_VM_DIRTY_RATIO 50
