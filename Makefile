...
HOSTCC       = ccache gcc
HOSTCXX      = ccache g++
HOSTCFLAGS   = $(GRAPHITEFLAGS) -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89
HOSTCXXFLAGS = $(GRAPHITEFLAGS) -O2
...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   --param max-tail-merge-comparisons=100 --param max-tail-merge-iterations=4 \
		   $(KERNELFLAGS)
